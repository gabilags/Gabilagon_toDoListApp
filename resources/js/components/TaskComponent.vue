        ...
        <div v-else>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="body">Description</label>
                        <input v-model="new_update_task.body" type="text" id="body" class="form-control"/>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    export default {
        ...
        methods:{
            ...
            updateTask(){
                axios.patch(this.uri+this.new_update_task.id,{name: this.new_update_task.name, body: this.new_update_task.body})
                .then(response=>{
